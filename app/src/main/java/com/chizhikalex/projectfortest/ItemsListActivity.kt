...
import com.chizhikalex.projectfortest.dummy.DummyContent
 ...
 * lead to a [ItemsDetailActivity] representing
...
class ItemsListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (items_detail_container != null) {
    ...
    class SimpleItemRecyclerViewAdapter(private val parentActivity: ItemsListActivity,
                ...
                if (twoPane) {
                    val fragment = ItemsDetailFragment().apply {
                        arguments = Bundle().apply {
                            putString(ItemsDetailFragment.ARG_ITEM_ID, item.id)
                        }
                    }
                    ...
                    val intent = Intent(v.context, ItemsDetailActivity::class.java).apply {
                        putExtra(ItemsDetailFragment.ARG_ITEM_ID, item.id)
                    }
